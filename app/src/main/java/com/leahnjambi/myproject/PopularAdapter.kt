...
class PopularAdapter(private val foodList: ArrayList<Food>)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FoodViewHolder {
        return FoodViewHolder (LayoutInflater.from(parent.context).inflate(R.layout.activity_popular, parent, false))
