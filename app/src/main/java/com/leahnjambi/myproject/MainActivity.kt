...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        foodList.add(Food(R.drawable.recipe1, "Veggie Pizza"))
        foodList.add(Food(R.drawable.recipe2, "Chapati"))
        foodList.add(Food(R.drawable.recipe3, "Mukimo"))
        foodList.add(Food(R.drawable.recipe4, "UnionVille"))
        foodList.add(Food(R.drawable.recipe5, " Cheese Burger"))
        foodList.add(Food(R.drawable.recipe6, "PanCake"))
        foodList.add(Food(R.drawable.recipe7, "Mushed potatoes"))
        foodList.add(Food(R.drawable.recipe8, "SweetCake"))
        foodList.add(Food(R.drawable.recipe9, "Biryani Rice"))
        foodList.add(Food(R.drawable.recipe10, "Crust Pizza"))
